                    ...
                    <div className="shop">
                        ...
                        {cartItems.map((product, index) =>{
                            ...
                            <div id = {"producto"+index} className="productoCarrito">
                                ...
                                <svg onClick={() => addCantidad(product.id)} id = {"añadir"+index} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-plus-circle precio" viewBox="0 0 16 16">
